   ...
   <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><img src="" alt="TrailMix" style="width:30px;height:30px;"></a>
            </div>
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    ?>
						...
						<li>
							<form class="navbar-form">
								<a href="register.php" class="btn btn-primary active" <?php session_write_close();?>>Sign Up</a>
							</form>
						</li>
                    <?php } ?>
                </ul>
